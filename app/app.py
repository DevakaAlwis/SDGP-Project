...
def findProducts():
    ...
    removeCollections(search_collection,reviews_collection,products_collection,amazon_reviews_collection,amazon_products_collection,walmart_reviews_collection,walmart_products_collection)
    ...
    process(search_collection,reviews_collection,products_collection,amazon_reviews_collection,amazon_products_collection,walmart_reviews_collection,walmart_products_collection)
    products=products_collection.find()
...
def removeCollections(search_collection,reviews_collection,products_collection,amazon_reviews_collection,amazon_products_collection,walmart_reviews_collection,walmart_products_collection):
    #delete previous collections
...
def process(search_collection,reviews_collection,products_collection,amazon_reviews_collection,amazon_products_collection,walmart_reviews_collection,walmart_products_collection):
    #scrape the products
    ...
    merging_collections.mergingProducts(products_collection,amazon_products_collection,walmart_products_collection)
    merging_collections.mergingProducts(reviews_collection,amazon_reviews_collection,walmart_reviews_collection)
    ...
    result=product_Update_db.updateSentimentLabels(reviews_collection,products_collection)
    print(result)
